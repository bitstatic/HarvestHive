        ...
        >
          ...
          >
            <Box className='w-full'>
              <TextField {...register("username")} label="Name" type='username' error={errors.username?true:false} variant="outlined" fullWidth />
              {errors.username && (
                <Typography color='error' variant='caption' className='w-full'>{errors.username.message}</Typography>
              )}
            </Box>
            <Box className='w-full'>
            ...
            <Box className='w-full'>
              <TextField {...register("PhoneNumber")} label="Phone Number" type='tel' error={errors.PhoneNumber?true:false} variant="outlined" fullWidth />
              {errors.PhoneNumber && (
                <Typography color='error' variant='caption' className='w-full'>{errors.PhoneNumber.message}</Typography>
              )}
            </Box>
            <Box className='w-full'>
