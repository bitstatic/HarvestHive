...
export const sendEmail = async ({email, emailType, userId} : any) => {
    ...
    try {
        ...
        if(emailType === "VERIFY") {
            await User.findByIdAndUpdate(userId, {verifyEmailToken: hashedToken, isEmailVerified: false, verifyEmailTokenExpiry: Date.now() + 3600000});
        ...
        const mailOptions ={
            ...
            <a href=" ${process.env.DOMAIN}/verifyemail/${hashedToken}">
